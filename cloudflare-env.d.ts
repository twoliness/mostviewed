/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 2e4ee164da7470fac08894705a9fd2d8)
// Runtime types generated with workerd@1.20250913.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VIDTRENDS_CACHE: KVNamespace;
		NEXTJS_ENV: string;
