// TypeScript interfaces converted to JSDoc comments for JavaScript usage

// Popular categories for navigation (only working categories)
export const POPULAR_CATEGORIES_DISPLAY = [
